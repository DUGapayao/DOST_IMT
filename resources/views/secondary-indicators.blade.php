<x-app-layout>
    ...
    <div class="options-container">
        <div class="NavHeader">
            <div class="NavTabs">
                <a href="{{ route('secondaryIndicators.index') }}" 
                   class="NavTab {{ request()->routeIs('secondaryIndicators.index') ? 'Active' : '' }}">
                    Draft
                </a>
                <a href="{{ route('secondaryIndicators.approved') }}" 
                   class="NavTab {{ request()->routeIs('secondaryIndicators.approved') ? 'Active' : '' }}">
                    Approved
                </a>
            </div>
