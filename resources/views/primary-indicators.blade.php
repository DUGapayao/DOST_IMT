<x-app-layout>
    ...
    <div class="options-container">
        <div style="display: flex; gap: 30px;">
            <div class="NavHeader">
                <div class="NavTabs">
                    <a href="{{ route('primaryIndicators.index') }}" class="NavTab {{ request()->routeIs('primaryIndicators.index') ? 'Active' : '' }}">
                        Draft
                    </a>
                    <a href="{{ route('primaryIndicators.approved') }}" class="NavTab {{ request()->routeIs('primaryIndicators.approved') ? 'Active' : '' }}">
                        Approved
                    </a>
                </div>
            </div>            
