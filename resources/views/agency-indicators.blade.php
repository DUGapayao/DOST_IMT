<x-app-layout>
    <x-title-page>Agency Indicators</x-title-page>
        ...
        <tbody>
            @foreach ($indicators as $indicator)
                <tr onclick="openEditDialog(
                    ...
                    <td>{{ $indicator->is_primary ? 'Primary' : 'Secondary'}}</td>
            ...
            <form method="POST" id="editForm">
                <div class="modal-main">
                    ...
                    <div class="input-container" id="create-input-container">
                        ...
                        <div class="input-container">
                            <label>Type</label>
                            <select class="select-input" id="edit_type" name="type">
                                <option disabled selected>Select Option</option>
                                <option value="1">Primary</option>
                                <option value="2">Secondary</option>
                            </select>
