            ...
            <nav class="NavHeader">
                <div class="NavTabs">
                    @if(!auth()->user()->isAdmin())
                        <a href="{{ route('primaryIndicators.index') }}"
                           class="NavTab {{ request()->routeIs('primaryIndicators.index') ? 'Active' : '' }}">
                            Draft
                        </a>
                    @endif
                    
                    <a href="{{ auth()->user()->isAdmin() 
                        ? route('primaryIndicators.pendingAdmin') 
                        : route('primaryIndicators.pending', ['id' => auth()->user()->id]) }}"
                       class="NavTab {{ request()->routeIs(auth()->user()->isAdmin() 
                        ? 'primaryIndicators.pendingAdmin' 
                        : 'primaryIndicators.pending') ? 'Active' : '' }}">
                        Pending
                    </a>
                    
                    <a href="{{ route('primaryIndicators.approved') }}"
                       class="NavTab {{ request()->routeIs('primaryIndicators.approved') ? 'Active' : '' }}">
                        Approved
                    </a>
                </div>
            </nav>
