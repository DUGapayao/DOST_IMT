...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    const faqsIcon = document.getElementById('faqs-dropdown-icon');
    ...
    faqsDropdown.addEventListener('click', function() {
        ...
        faqsIcon.style.transform = isCurrentlyOpen ? 'rotate(0deg)' : 'rotate(180deg)';
    ...
    const helpIcon = document.getElementById('online-help-dropdown-icon');
    const isHelpDropdownOpen = @json(session('help_dropdown_open', false));

    if (isHelpDropdownOpen) {
        helpContent.style.display = 'block';
        helpIcon.style.transform = 'rotate(180deg)';
    }
    ...
    helpDropdown.addEventListener('click', function() {
        ...
        helpIcon.style.transform = isCurrentlyOpen ? 'rotate(0deg)' : 'rotate(180deg)';
